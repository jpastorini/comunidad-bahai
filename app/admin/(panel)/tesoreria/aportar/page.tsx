  ...
  return (
    <>
      <PageHeader
        eyebrow="Tesorería"
        title="Cómo aportar"
        description="Los medios de pago y la cifra del Fondo que se muestran en la sección Tesorería de la app de la comunidad."
      />
      ...
      {/* Los compromisos tienen su propia pantalla desde la 063: ahí se
          ven contra el libro del mes, que es lo que el tesorero necesita. */}
      <Card className="mb-5">
        ...
        <p className="mt-1 text-[12px] text-muted">
          ...
          , donde además se ve, mes a mes, quién ya aportó y quién todavía no.
        </p>
      </Card>
